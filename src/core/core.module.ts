...
import { CreateMenuCommand, CreateMenuHandler, CreateSubmenuCommand, CreateSubmenuHandler, DeleteMenuCommand, DeleteMenuHandler, DeleteMenuSistemaCommand, DeleteMenuSistemaHandler, DeleteSubmenuOpcionCommand, DeleteSubmenuOpcionHandler, UpdateMenuCommand, UpdateMenuHandler } from './application/feautures/Menu/write';
...
import { SistemaByBusquedaQuery, SistemaByBusquedaQueryHandler } from './application/feautures/Sistema/read/sistemaByBusqueda';
...
const SISTEMA_PROVIDERS=[
    ...
    SistemaByBusquedaQuery,
    SistemaByBusquedaQueryHandler
]
...
const MENU_PROVIDERS=[
    ...
    DeleteSubmenuOpcionCommand,
    DeleteSubmenuOpcionHandler
]
